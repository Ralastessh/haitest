...
#터미널에서 코드 실행시 설정할 수 있는 옵션 목록
parser = argparse.ArgumentParser(description = "TalkNet Settings")

parser.add_argument('--videoName',             type=str, default="my_video",   help='Input video name')
parser.add_argument('--videoFolder',           type=str, default="input",  help='Path for inputs, tmps and outputs')
...
#args 객체 속으로 videoPath와 savePath 추가
args.videoPath = os.path.join(args.videoFolder, args.videoName + '.*')
